 ...
 * </p>
 * <p>
 * Copyright: Copyright (c) 2003 Colin Barrï¿½-Brisebois, ï¿½ric Paquette
 * </p>
 * <p>
 * Company: ETS - ï¿½cole de Technologie Supï¿½rieure
 * </p>
 * 
 * @author unascribed
...
public class ImageLineFiller extends AbstractTransformer {
	...
	private void insideFill(Point ptClicked) {
		...
		while (!stack.empty()) {
			...
			if (0 <= current.x && current.x < currentImage.getImageWidth()
				...
				// Validation de la rÃ©gion pour le changement de la couleur
	...
	/**
	 * *MÃ©thode qui permet de faire la transformation de RGB a HSV
